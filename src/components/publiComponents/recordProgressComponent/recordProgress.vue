      ...
      <li v-for="(item,key) in recordProgressData" :key="key">
        ...
        <div>
          ...
          <div v-show="item.flagNum ==0 && item.formStatus == '已验收'" style="float: right;">
            <button style="color:white;background-color:#A260A4;width: 70px;height: 22px;border-radius: 10px;text-align: center;margin-left: 20px;padding: 0 20px;" @click.stop="clickEvaluateBtn()">评价</button>
          </div>
